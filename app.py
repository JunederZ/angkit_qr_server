...
app.add_url_rule('/removeUser', view_func=routes.remove_user, methods=['POST'])
...
app.add_url_rule('/updateBatch', view_func=routes.update_batch, methods=['POST'])
# app.add_url_rule('/updateUser', view_func=routes.update_user, methods=['POST'])
